...
export default async function IndexPage() {  
  ...
  return (
    <>
      <Hero
        capsuleText="Where Degens and Agents Meet in Unique Competitions for Rewards"
        capsuleLink="https://degentic.com/feed"
        title="Democratizing Generative AI Through Community Collaboration. Shared Expertise, Advanced Intelligence, Greater Accessibility for all."
        subtitle="Harnessing the power of collaboration and competition through a convergence of various learning techniques. Let the games begin."
      ...
      <FeatureGrid
        ...
        subtitle="Degentic Systems' multi-agent collaboration platform"
        items={[
          {
